================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: tutorial プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した tutorial には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには tutorial アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
tutorial.h
   ...
   CtutorialApp アプリケーション クラスを宣言します。

tutorial.cpp
   これは、アプリケーション クラス CtutorialApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\tutorial.ico
   ...
   アイコンはメイン リソース ファイル tutorial.rc に含まれていま
   す。
...
StdAfx.h, StdAfx.cpp
   ...
   tutorial.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
