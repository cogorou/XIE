namespace XIE.Tasks
{
	partial class CxScriptToolboxFind
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CxScriptToolboxFind));
			...
			this.Name = "CxScriptToolboxFind";
			this.ShowInTaskbar = false;
			this.Text = "Find";
			this.Load += new System.EventHandler(this.EditorToolboxFind_Load);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.EditorToolboxFind_KeyDown);
