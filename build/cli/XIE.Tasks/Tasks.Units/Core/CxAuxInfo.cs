	...
	public class CxAuxInfo_Camera_Controller : CxTaskUnit
	{
		...
		public override void Assign(CxTaskPortOut target_port, object value)
		{
			...
			switch (dst_index)
			{
				case 0:
					{
						target_port.Data = (XIE.Media.CxCamera)value;
						return;
					}
			}
	...
	public class CxAuxInfo_SerialPort_Controller : CxTaskUnit
	{
		...
		public override void Assign(CxTaskPortOut target_port, object value)
		{
			...
			switch (dst_index)
			{
				case 0:
					{
						target_port.Data = (XIE.IO.CxSerialPort)value;
						return;
					}
			}
			throw new NotSupportedException();
	...
	public class CxAuxInfo_TcpServer_Controller : CxTaskUnit
	{
		...
		public override void Assign(CxTaskPortOut target_port, object value)
		{
			...
			switch (dst_index)
			{
				case 0:
					{
						target_port.Data = (XIE.Net.CxTcpServer)value;
						return;
					}
			}
			throw new NotSupportedException();
	...
	public class CxAuxInfo_TcpClient_Controller : CxTaskUnit
	{
		...
		public override void Assign(CxTaskPortOut target_port, object value)
		{
			...
			switch (dst_index)
			{
				case 0:
					{
						target_port.Data = (XIE.Net.CxTcpClient)value;
						return;
					}
			}
			throw new NotSupportedException();
	...
	public class CxAuxInfo_Media_Player : CxTaskUnit
	{
		...
		public override void Assign(CxTaskPortOut target_port, object value)
		{
			...
			switch (dst_index)
			{
				case 0:
					{
						target_port.Data = (XIE.Media.CxMediaPlayer)value;
						return;
					}
			}
			throw new NotSupportedException();
	...
	public class CxTcpServer_Stream : CxTaskUnit
	{
		...
		public override void Assign(CxTaskPortOut target_port, object value)
		{
			...
			switch (dst_index)
			{
				case 0:
					{
						target_port.Data = (XIE.Net.TxSocketStream)value;
						return;
					}
			}
			throw new NotSupportedException();
