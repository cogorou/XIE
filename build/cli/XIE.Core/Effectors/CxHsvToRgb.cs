...
{
	/// <summary>
	/// 色空間変換クラス (HSV から RGB への変換)
	/// </summary>
	[Serializable]
	[TypeConverter(typeof(CxSortingConverter))]
	public class CxHsvToRgb : System.Object
		, ICloneable
		, IxEquatable
	{
		#region フィールド:
		...
		[CxDescription("P:XIE.Effectors.CxHsvToRgb.Depth")]
		...
		public virtual void Execute(IxModule src, IxModule dst, IxModule mask = null)
		{
			...
			ExStatus status = xie_core.fnXIE_Effectors_HsvToRgb(hsrc, hdst, hmask, Depth);
