...
namespace XIE.Effectors
{
	...
	public class CxBinarize2 : System.Object
		, ICloneable
		, IxEquatable
	{
		#region フィールド:

		TxRangeD m_Threshold;
		bool m_UseAbs;
		TxRangeD m_Value;
		...
		[CxDescription("P:XIE.Effectors.CxBinarize2.Threshold")]
		public unsafe TxRangeD Threshold
		{
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.Effectors.CxBinarize2.UseAbs")]
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.Effectors.CxBinarize2.Value")]
		...
		{
			m_Threshold = new TxRangeD(96, 160);
			m_UseAbs = false;
		...
		public CxBinarize2(TxRangeD threshold, bool use_abs, TxRangeD value)
		{
			_Constructor();
		...
		public virtual void Execute(IxModule src, IxModule dst, IxModule mask = null)
		{
			...
			ExStatus status = xie_core.fnXIE_Effectors_Binarize2(hsrc, hdst, hmask, Threshold, UseAbs, Value);
