...
namespace XIE.Effectors
{
	...
	public class CxMonochrome : System.Object
		, ICloneable
		, IxEquatable
	{
		#region フィールド:
		...
		[CxDescription("P:XIE.Effectors.CxMonochrome.RedRatio")]
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.Effectors.CxMonochrome.GreenRatio")]
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.Effectors.CxMonochrome.BlueRatio")]
		...
		public CxMonochrome(double red_ratio, double green_ratio, double blue_ratio)
		{
			_Constructor();
		...
		public virtual void CopyFrom(object src)
		{
			...
			if (src is CxMonochrome)
			{
				var _dst = this;
				var _src = (CxMonochrome)src;
		...
		public virtual void Execute(IxModule src, IxModule dst, IxModule mask = null)
		{
			...
			ExStatus status = xie_core.fnXIE_Effectors_Monochrome(hsrc, hdst, hmask, RedRatio, GreenRatio, BlueRatio);
