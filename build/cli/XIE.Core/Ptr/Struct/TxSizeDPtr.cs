...
namespace XIE.Ptr
{
	using ITEM_TYPE = TxSizeD;

	/// <summary>
	/// TxSizeD 構造体のポインタ
	/// </summary>
	public struct TxSizeDPtr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe TxSizeDPtr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is TxSizeDPtr)) return false;
			return (this.m_Address == ((TxSizeDPtr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(TxSizeDPtr ope1, TxSizeDPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(TxSizeDPtr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, TxSizeDPtr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→TxSizeDPtr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←TxSizeDPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(TxSizeDPtr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxSizeDPtr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxSizeDPtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator TxSizeDPtr(Int32 src)
		{
			return new TxSizeDPtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←TxSizeDPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(TxSizeDPtr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxSizeDPtr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxSizeDPtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator TxSizeDPtr(Int64 src)
		{
			return new TxSizeDPtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←TxSizeDPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(TxSizeDPtr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxSizeDPtr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxSizeDPtr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator TxSizeDPtr(void* src)
		{
			return new TxSizeDPtr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→TxSizeDPtr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←TxSizeDPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(TxSizeDPtr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (TxSizeDPtr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxSizeDPtr 構造体に代入して返します。
		///	</returns>
		public static implicit operator TxSizeDPtr(IntPtr src)
		{
			return new TxSizeDPtr(src);
		}
		...
		/// </returns>
		public static unsafe TxSizeDPtr operator +(TxSizeDPtr src, Int32 value)
		{
			return new TxSizeDPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxSizeDPtr operator +(TxSizeDPtr src, UInt32 value)
		{
			return new TxSizeDPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxSizeDPtr operator +(TxSizeDPtr src, Int64 value)
		{
			return new TxSizeDPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxSizeDPtr operator +(TxSizeDPtr src, UInt64 value)
		{
			return new TxSizeDPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxSizeDPtr operator +(TxSizeDPtr src, SIZE_T value)
		{
			return new TxSizeDPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe TxSizeDPtr At(int index)
		{
			return new TxSizeDPtr(((ITEM_TYPE*)m_Address) + index);
		}
