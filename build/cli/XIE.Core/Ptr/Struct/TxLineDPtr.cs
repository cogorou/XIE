...
namespace XIE.Ptr
{
	using ITEM_TYPE = TxLineD;

	/// <summary>
	/// TxLineD 構造体のポインタ
	/// </summary>
	public struct TxLineDPtr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe TxLineDPtr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is TxLineDPtr)) return false;
			return (this.m_Address == ((TxLineDPtr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(TxLineDPtr ope1, TxLineDPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(TxLineDPtr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, TxLineDPtr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→TxLineDPtr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←TxLineDPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(TxLineDPtr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxLineDPtr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxLineDPtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator TxLineDPtr(Int32 src)
		{
			return new TxLineDPtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←TxLineDPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(TxLineDPtr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxLineDPtr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxLineDPtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator TxLineDPtr(Int64 src)
		{
			return new TxLineDPtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←TxLineDPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(TxLineDPtr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxLineDPtr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxLineDPtr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator TxLineDPtr(void* src)
		{
			return new TxLineDPtr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→TxLineDPtr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←TxLineDPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(TxLineDPtr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (TxLineDPtr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxLineDPtr 構造体に代入して返します。
		///	</returns>
		public static implicit operator TxLineDPtr(IntPtr src)
		{
			return new TxLineDPtr(src);
		}
		...
		/// </returns>
		public static unsafe TxLineDPtr operator +(TxLineDPtr src, Int32 value)
		{
			return new TxLineDPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxLineDPtr operator +(TxLineDPtr src, UInt32 value)
		{
			return new TxLineDPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxLineDPtr operator +(TxLineDPtr src, Int64 value)
		{
			return new TxLineDPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxLineDPtr operator +(TxLineDPtr src, UInt64 value)
		{
			return new TxLineDPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxLineDPtr operator +(TxLineDPtr src, SIZE_T value)
		{
			return new TxLineDPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe TxLineDPtr At(int index)
		{
			return new TxLineDPtr(((ITEM_TYPE*)m_Address) + index);
		}
