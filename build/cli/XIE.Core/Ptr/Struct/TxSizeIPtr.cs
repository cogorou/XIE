...
namespace XIE.Ptr
{
	using ITEM_TYPE = TxSizeI;

	/// <summary>
	/// TxSizeI 構造体のポインタ
	/// </summary>
	public struct TxSizeIPtr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe TxSizeIPtr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is TxSizeIPtr)) return false;
			return (this.m_Address == ((TxSizeIPtr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(TxSizeIPtr ope1, TxSizeIPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(TxSizeIPtr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, TxSizeIPtr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→TxSizeIPtr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←TxSizeIPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(TxSizeIPtr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxSizeIPtr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxSizeIPtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator TxSizeIPtr(Int32 src)
		{
			return new TxSizeIPtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←TxSizeIPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(TxSizeIPtr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxSizeIPtr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxSizeIPtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator TxSizeIPtr(Int64 src)
		{
			return new TxSizeIPtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←TxSizeIPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(TxSizeIPtr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxSizeIPtr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxSizeIPtr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator TxSizeIPtr(void* src)
		{
			return new TxSizeIPtr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→TxSizeIPtr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←TxSizeIPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(TxSizeIPtr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (TxSizeIPtr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxSizeIPtr 構造体に代入して返します。
		///	</returns>
		public static implicit operator TxSizeIPtr(IntPtr src)
		{
			return new TxSizeIPtr(src);
		}
		...
		/// </returns>
		public static unsafe TxSizeIPtr operator +(TxSizeIPtr src, Int32 value)
		{
			return new TxSizeIPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxSizeIPtr operator +(TxSizeIPtr src, UInt32 value)
		{
			return new TxSizeIPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxSizeIPtr operator +(TxSizeIPtr src, Int64 value)
		{
			return new TxSizeIPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxSizeIPtr operator +(TxSizeIPtr src, UInt64 value)
		{
			return new TxSizeIPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxSizeIPtr operator +(TxSizeIPtr src, SIZE_T value)
		{
			return new TxSizeIPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe TxSizeIPtr At(int index)
		{
			return new TxSizeIPtr(((ITEM_TYPE*)m_Address) + index);
		}
