...
namespace XIE.Ptr
{
	using ITEM_TYPE = TxLineI;

	/// <summary>
	/// TxLineI 構造体のポインタ
	/// </summary>
	public struct TxLineIPtr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe TxLineIPtr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is TxLineIPtr)) return false;
			return (this.m_Address == ((TxLineIPtr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(TxLineIPtr ope1, TxLineIPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(TxLineIPtr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, TxLineIPtr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→TxLineIPtr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←TxLineIPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(TxLineIPtr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxLineIPtr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxLineIPtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator TxLineIPtr(Int32 src)
		{
			return new TxLineIPtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←TxLineIPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(TxLineIPtr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxLineIPtr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxLineIPtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator TxLineIPtr(Int64 src)
		{
			return new TxLineIPtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←TxLineIPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(TxLineIPtr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (TxLineIPtr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxLineIPtr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator TxLineIPtr(void* src)
		{
			return new TxLineIPtr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→TxLineIPtr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←TxLineIPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(TxLineIPtr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (TxLineIPtr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		TxLineIPtr 構造体に代入して返します。
		///	</returns>
		public static implicit operator TxLineIPtr(IntPtr src)
		{
			return new TxLineIPtr(src);
		}
		...
		/// </returns>
		public static unsafe TxLineIPtr operator +(TxLineIPtr src, Int32 value)
		{
			return new TxLineIPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxLineIPtr operator +(TxLineIPtr src, UInt32 value)
		{
			return new TxLineIPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxLineIPtr operator +(TxLineIPtr src, Int64 value)
		{
			return new TxLineIPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxLineIPtr operator +(TxLineIPtr src, UInt64 value)
		{
			return new TxLineIPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe TxLineIPtr operator +(TxLineIPtr src, SIZE_T value)
		{
			return new TxLineIPtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe TxLineIPtr At(int index)
		{
			return new TxLineIPtr(((ITEM_TYPE*)m_Address) + index);
		}
