...
namespace XIE.Ptr
{
	using ITEM_TYPE = System.Byte;

	/// <summary>
	/// Byte 構造体のポインタ
	/// </summary>
	public struct BytePtr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe BytePtr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is BytePtr)) return false;
			return (this.m_Address == ((BytePtr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(BytePtr ope1, BytePtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(BytePtr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, BytePtr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→BytePtr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←BytePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(BytePtr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (BytePtr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		BytePtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator BytePtr(Int32 src)
		{
			return new BytePtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←BytePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(BytePtr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (BytePtr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		BytePtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator BytePtr(Int64 src)
		{
			return new BytePtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←BytePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(BytePtr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (BytePtr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		BytePtr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator BytePtr(void* src)
		{
			return new BytePtr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→BytePtr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←BytePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(BytePtr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (BytePtr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		BytePtr 構造体に代入して返します。
		///	</returns>
		public static implicit operator BytePtr(IntPtr src)
		{
			return new BytePtr(src);
		}
		...
		/// </returns>
		public static unsafe BytePtr operator +(BytePtr src, Int32 value)
		{
			return new BytePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe BytePtr operator +(BytePtr src, UInt32 value)
		{
			return new BytePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe BytePtr operator +(BytePtr src, Int64 value)
		{
			return new BytePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe BytePtr operator +(BytePtr src, UInt64 value)
		{
			return new BytePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe BytePtr operator +(BytePtr src, SIZE_T value)
		{
			return new BytePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe BytePtr At(int index)
		{
			return new BytePtr(((ITEM_TYPE*)m_Address) + index);
		}
