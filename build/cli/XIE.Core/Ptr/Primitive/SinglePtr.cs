...
namespace XIE.Ptr
{
	using ITEM_TYPE = System.Single;

	/// <summary>
	/// Single 構造体のポインタ
	/// </summary>
	public struct SinglePtr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe SinglePtr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is SinglePtr)) return false;
			return (this.m_Address == ((SinglePtr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(SinglePtr ope1, SinglePtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(SinglePtr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, SinglePtr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→SinglePtr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←SinglePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(SinglePtr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (SinglePtr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		SinglePtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator SinglePtr(Int32 src)
		{
			return new SinglePtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←SinglePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(SinglePtr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (SinglePtr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		SinglePtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator SinglePtr(Int64 src)
		{
			return new SinglePtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←SinglePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(SinglePtr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (SinglePtr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		SinglePtr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator SinglePtr(void* src)
		{
			return new SinglePtr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→SinglePtr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←SinglePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(SinglePtr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (SinglePtr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		SinglePtr 構造体に代入して返します。
		///	</returns>
		public static implicit operator SinglePtr(IntPtr src)
		{
			return new SinglePtr(src);
		}
		...
		/// </returns>
		public static unsafe SinglePtr operator +(SinglePtr src, Int32 value)
		{
			return new SinglePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe SinglePtr operator +(SinglePtr src, UInt32 value)
		{
			return new SinglePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe SinglePtr operator +(SinglePtr src, Int64 value)
		{
			return new SinglePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe SinglePtr operator +(SinglePtr src, UInt64 value)
		{
			return new SinglePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe SinglePtr operator +(SinglePtr src, SIZE_T value)
		{
			return new SinglePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe SinglePtr At(int index)
		{
			return new SinglePtr(((ITEM_TYPE*)m_Address) + index);
		}
