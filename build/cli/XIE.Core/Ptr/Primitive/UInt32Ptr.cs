...
namespace XIE.Ptr
{
	using ITEM_TYPE = System.UInt32;

	/// <summary>
	/// UInt32 構造体のポインタ
	/// </summary>
	public struct UInt32Ptr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe UInt32Ptr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is UInt32Ptr)) return false;
			return (this.m_Address == ((UInt32Ptr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(UInt32Ptr ope1, UInt32Ptr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(UInt32Ptr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, UInt32Ptr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→UInt32Ptr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←UInt32Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(UInt32Ptr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (UInt32Ptr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		UInt32Ptr 構造体に代入して返します。
		///	</returns>
		public static explicit operator UInt32Ptr(Int32 src)
		{
			return new UInt32Ptr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←UInt32Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(UInt32Ptr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (UInt32Ptr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		UInt32Ptr 構造体に代入して返します。
		///	</returns>
		public static explicit operator UInt32Ptr(Int64 src)
		{
			return new UInt32Ptr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←UInt32Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(UInt32Ptr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (UInt32Ptr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		UInt32Ptr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator UInt32Ptr(void* src)
		{
			return new UInt32Ptr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→UInt32Ptr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←UInt32Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(UInt32Ptr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (UInt32Ptr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		UInt32Ptr 構造体に代入して返します。
		///	</returns>
		public static implicit operator UInt32Ptr(IntPtr src)
		{
			return new UInt32Ptr(src);
		}
		...
		/// </returns>
		public static unsafe UInt32Ptr operator +(UInt32Ptr src, Int32 value)
		{
			return new UInt32Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe UInt32Ptr operator +(UInt32Ptr src, UInt32 value)
		{
			return new UInt32Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe UInt32Ptr operator +(UInt32Ptr src, Int64 value)
		{
			return new UInt32Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe UInt32Ptr operator +(UInt32Ptr src, UInt64 value)
		{
			return new UInt32Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe UInt32Ptr operator +(UInt32Ptr src, SIZE_T value)
		{
			return new UInt32Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe UInt32Ptr At(int index)
		{
			return new UInt32Ptr(((ITEM_TYPE*)m_Address) + index);
		}
