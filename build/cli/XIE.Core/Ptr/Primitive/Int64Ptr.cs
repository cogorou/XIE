...
namespace XIE.Ptr
{
	using ITEM_TYPE = System.Int64;

	/// <summary>
	/// Int64 構造体のポインタ
	/// </summary>
	public struct Int64Ptr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe Int64Ptr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is Int64Ptr)) return false;
			return (this.m_Address == ((Int64Ptr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(Int64Ptr ope1, Int64Ptr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(Int64Ptr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, Int64Ptr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→Int64Ptr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←Int64Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(Int64Ptr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64Ptr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64Ptr 構造体に代入して返します。
		///	</returns>
		public static explicit operator Int64Ptr(Int32 src)
		{
			return new Int64Ptr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←Int64Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(Int64Ptr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64Ptr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64Ptr 構造体に代入して返します。
		///	</returns>
		public static explicit operator Int64Ptr(Int64 src)
		{
			return new Int64Ptr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←Int64Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(Int64Ptr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64Ptr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64Ptr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator Int64Ptr(void* src)
		{
			return new Int64Ptr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→Int64Ptr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←Int64Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(Int64Ptr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (Int64Ptr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64Ptr 構造体に代入して返します。
		///	</returns>
		public static implicit operator Int64Ptr(IntPtr src)
		{
			return new Int64Ptr(src);
		}
		...
		/// </returns>
		public static unsafe Int64Ptr operator +(Int64Ptr src, Int32 value)
		{
			return new Int64Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe Int64Ptr operator +(Int64Ptr src, UInt32 value)
		{
			return new Int64Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe Int64Ptr operator +(Int64Ptr src, Int64 value)
		{
			return new Int64Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe Int64Ptr operator +(Int64Ptr src, UInt64 value)
		{
			return new Int64Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe Int64Ptr operator +(Int64Ptr src, SIZE_T value)
		{
			return new Int64Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe Int64Ptr At(int index)
		{
			return new Int64Ptr(((ITEM_TYPE*)m_Address) + index);
		}
