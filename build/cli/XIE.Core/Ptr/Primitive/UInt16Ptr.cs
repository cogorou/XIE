...
namespace XIE.Ptr
{
	using ITEM_TYPE = System.UInt16;

	/// <summary>
	/// UInt16 構造体のポインタ
	/// </summary>
	public struct UInt16Ptr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe UInt16Ptr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is UInt16Ptr)) return false;
			return (this.m_Address == ((UInt16Ptr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(UInt16Ptr ope1, UInt16Ptr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(UInt16Ptr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, UInt16Ptr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→UInt16Ptr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←UInt16Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(UInt16Ptr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (UInt16Ptr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		UInt16Ptr 構造体に代入して返します。
		///	</returns>
		public static explicit operator UInt16Ptr(Int32 src)
		{
			return new UInt16Ptr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←UInt16Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(UInt16Ptr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (UInt16Ptr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		UInt16Ptr 構造体に代入して返します。
		///	</returns>
		public static explicit operator UInt16Ptr(Int64 src)
		{
			return new UInt16Ptr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←UInt16Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(UInt16Ptr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (UInt16Ptr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		UInt16Ptr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator UInt16Ptr(void* src)
		{
			return new UInt16Ptr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→UInt16Ptr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←UInt16Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(UInt16Ptr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (UInt16Ptr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		UInt16Ptr 構造体に代入して返します。
		///	</returns>
		public static implicit operator UInt16Ptr(IntPtr src)
		{
			return new UInt16Ptr(src);
		}
		...
		/// </returns>
		public static unsafe UInt16Ptr operator +(UInt16Ptr src, Int32 value)
		{
			return new UInt16Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe UInt16Ptr operator +(UInt16Ptr src, UInt32 value)
		{
			return new UInt16Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe UInt16Ptr operator +(UInt16Ptr src, Int64 value)
		{
			return new UInt16Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe UInt16Ptr operator +(UInt16Ptr src, UInt64 value)
		{
			return new UInt16Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe UInt16Ptr operator +(UInt16Ptr src, SIZE_T value)
		{
			return new UInt16Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe UInt16Ptr At(int index)
		{
			return new UInt16Ptr(((ITEM_TYPE*)m_Address) + index);
		}
