...
namespace XIE.Ptr
{
	using ITEM_TYPE = System.Int32;

	/// <summary>
	/// Int32 構造体のポインタ
	/// </summary>
	public struct Int32Ptr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe Int32Ptr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is Int32Ptr)) return false;
			return (this.m_Address == ((Int32Ptr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(Int32Ptr ope1, Int32Ptr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(Int32Ptr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, Int32Ptr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→Int32Ptr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←Int32Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(Int32Ptr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int32Ptr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32Ptr 構造体に代入して返します。
		///	</returns>
		public static explicit operator Int32Ptr(Int32 src)
		{
			return new Int32Ptr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←Int32Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(Int32Ptr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int32Ptr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32Ptr 構造体に代入して返します。
		///	</returns>
		public static explicit operator Int32Ptr(Int64 src)
		{
			return new Int32Ptr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←Int32Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(Int32Ptr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int32Ptr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32Ptr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator Int32Ptr(void* src)
		{
			return new Int32Ptr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→Int32Ptr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←Int32Ptr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(Int32Ptr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (Int32Ptr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32Ptr 構造体に代入して返します。
		///	</returns>
		public static implicit operator Int32Ptr(IntPtr src)
		{
			return new Int32Ptr(src);
		}
		...
		/// </returns>
		public static unsafe Int32Ptr operator +(Int32Ptr src, Int32 value)
		{
			return new Int32Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe Int32Ptr operator +(Int32Ptr src, UInt32 value)
		{
			return new Int32Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe Int32Ptr operator +(Int32Ptr src, Int64 value)
		{
			return new Int32Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe Int32Ptr operator +(Int32Ptr src, UInt64 value)
		{
			return new Int32Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe Int32Ptr operator +(Int32Ptr src, SIZE_T value)
		{
			return new Int32Ptr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe Int32Ptr At(int index)
		{
			return new Int32Ptr(((ITEM_TYPE*)m_Address) + index);
		}
