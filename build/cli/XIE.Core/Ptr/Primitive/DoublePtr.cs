...
namespace XIE.Ptr
{
	using ITEM_TYPE = System.Double;

	/// <summary>
	/// Double 構造体のポインタ
	/// </summary>
	public struct DoublePtr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe DoublePtr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is DoublePtr)) return false;
			return (this.m_Address == ((DoublePtr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(DoublePtr ope1, DoublePtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(DoublePtr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, DoublePtr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→DoublePtr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←DoublePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(DoublePtr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (DoublePtr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		DoublePtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator DoublePtr(Int32 src)
		{
			return new DoublePtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←DoublePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(DoublePtr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (DoublePtr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		DoublePtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator DoublePtr(Int64 src)
		{
			return new DoublePtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←DoublePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(DoublePtr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (DoublePtr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		DoublePtr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator DoublePtr(void* src)
		{
			return new DoublePtr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→DoublePtr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←DoublePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(DoublePtr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (DoublePtr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		DoublePtr 構造体に代入して返します。
		///	</returns>
		public static implicit operator DoublePtr(IntPtr src)
		{
			return new DoublePtr(src);
		}
		...
		/// </returns>
		public static unsafe DoublePtr operator +(DoublePtr src, Int32 value)
		{
			return new DoublePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe DoublePtr operator +(DoublePtr src, UInt32 value)
		{
			return new DoublePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe DoublePtr operator +(DoublePtr src, Int64 value)
		{
			return new DoublePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe DoublePtr operator +(DoublePtr src, UInt64 value)
		{
			return new DoublePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe DoublePtr operator +(DoublePtr src, SIZE_T value)
		{
			return new DoublePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe DoublePtr At(int index)
		{
			return new DoublePtr(((ITEM_TYPE*)m_Address) + index);
		}
