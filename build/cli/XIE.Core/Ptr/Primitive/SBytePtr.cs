...
namespace XIE.Ptr
{
	using ITEM_TYPE = System.SByte;

	/// <summary>
	/// SByte 構造体のポインタ
	/// </summary>
	public struct SBytePtr : IxPointer<ITEM_TYPE>, IxEquatable
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="ptr">配列の先頭アドレス</param>
		public unsafe SBytePtr(void* ptr)
		{
			m_Address = new IntPtr(ptr);
		}
		...
		public override bool Equals (object src)
		{
			...
			if (!(src is SBytePtr)) return false;
			return (this.m_Address == ((SBytePtr)src).m_Address);
		}
		...
		/// </returns>
		public static bool operator ==(SBytePtr ope1, SBytePtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(SBytePtr ope1, System.IntPtr ope2)
		{
		...
		///		一致する場合は true、一致しない場合は false を返します。
		/// </returns>
		public static bool operator ==(System.IntPtr ope1, SBytePtr ope2)
		{
		...
		#region 明示的な型変換演算子 (Any←／→SBytePtr)

		/// <summary>
		/// 明示的な型変換演算子 (Int32←SBytePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int32 に変換して返します。
		///	</returns>
		public static explicit operator Int32(SBytePtr src)
		{
			return src.m_Address.ToInt32();
		}

		/// <summary>
		/// 明示的な型変換演算子 (SBytePtr←Int32)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		SBytePtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator SBytePtr(Int32 src)
		{
			return new SBytePtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (Int64←SBytePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		Int64 に変換して返します。
		///	</returns>
		public static explicit operator Int64(SBytePtr src)
		{
			return src.m_Address.ToInt64();
		}

		/// <summary>
		/// 明示的な型変換演算子 (SBytePtr←Int64)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		SBytePtr 構造体に代入して返します。
		///	</returns>
		public static explicit operator SBytePtr(Int64 src)
		{
			return new SBytePtr(src);
		}

		/// <summary>
		/// 明示的な型変換演算子 (void*←SBytePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		void* に変換して返します。
		///	</returns>
		public static unsafe explicit operator void*(SBytePtr src)
		{
			return src.m_Address.ToPointer();
		}

		/// <summary>
		/// 明示的な型変換演算子 (SBytePtr←void*)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		SBytePtr 構造体に代入して返します。
		///	</returns>
		public static unsafe explicit operator SBytePtr(void* src)
		{
			return new SBytePtr(src);
		}
		...
		#region 暗黙的な型変換演算子 (IntPtr←／→SBytePtr)

		/// <summary>
		/// 暗黙的な型変換演算子 (IntPtr←SBytePtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		IntPtr に変換して返します。
		///	</returns>
		public static implicit operator IntPtr(SBytePtr src)
		{
			return src.m_Address;
		}

		/// <summary>
		/// 暗黙的な型変換演算子 (SBytePtr←IntPtr)
		/// </summary>
		/// <param name="src">複製元</param>
		/// <returns>
		///		SBytePtr 構造体に代入して返します。
		///	</returns>
		public static implicit operator SBytePtr(IntPtr src)
		{
			return new SBytePtr(src);
		}
		...
		/// </returns>
		public static unsafe SBytePtr operator +(SBytePtr src, Int32 value)
		{
			return new SBytePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe SBytePtr operator +(SBytePtr src, UInt32 value)
		{
			return new SBytePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe SBytePtr operator +(SBytePtr src, Int64 value)
		{
			return new SBytePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe SBytePtr operator +(SBytePtr src, UInt64 value)
		{
			return new SBytePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		///		指定された値をアドレスに加算して返します。
		/// </returns>
		public static unsafe SBytePtr operator +(SBytePtr src, SIZE_T value)
		{
			return new SBytePtr(((ITEM_TYPE*)src.m_Address) + value);
		}
		...
		/// </returns>
		public unsafe SBytePtr At(int index)
		{
			return new SBytePtr(((ITEM_TYPE*)m_Address) + index);
		}
