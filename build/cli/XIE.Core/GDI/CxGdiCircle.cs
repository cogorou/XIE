...
namespace XIE.GDI
{
	...
	public struct CxGdiCircle
		: IEquatable<CxGdiCircle>
		, ICloneable
		, IxGdi2d
	{
		#region フィールド:
		...
		/// 既定値
		/// </summary>
		public static CxGdiCircle Default
		{
			get
			{
				var result = new CxGdiCircle();
				result.Angle = 0;
				result.Axis = new TxPointD(0, 0);
				result.Pen = TxGdiPen.Default;
				result.Brush = TxGdiBrush.Default;
				result.Shape = new TxCircleD(0, 0, 0);
				return result;
			}
		}
		...
		public CxGdiCircle(double x, double y, double radius)
		{
			m_Visible = true;
			m_Angle = 0;
			...
			Shape = new TxCircleD(x, y, radius);
		}
		...
		/// <param name="radius">半径</param>
		public CxGdiCircle(TxPointD center, double radius)
		{
			m_Visible = true;
			m_Angle = 0;
			m_Axis = new TxPointD(0, 0);
			Pen = TxGdiPen.Default;
			Brush = TxGdiBrush.Default;
			Shape = new TxCircleD(center, radius);
		}
		...
		public CxGdiCircle(TxCircleD shape)
		{
			m_Visible = true;
			m_Angle = 0;
			m_Axis = new TxPointD(0, 0);
		...
		/// </summary>
		/// <param name="shape">図形の形状</param>
		public CxGdiCircle(TxCircleI shape)
		{
			m_Visible = true;
			m_Angle = 0;
			m_Axis = new TxPointD(0, 0);
		...
		/// </returns>
		public bool Equals(CxGdiCircle other)
		{
		...
		public override bool Equals(object obj)
		{
			...
			if (!(obj is CxGdiCircle)) return false;
			return this.Equals((CxGdiCircle)obj);
		}
		...
		///		内容が等しい場合は true、それ以外は false を返します。
		/// </returns>
		public static bool operator ==(CxGdiCircle left, CxGdiCircle right)
		{
		...
		///		新しく生成したオブジェクトを返します。
		/// </returns>
		public static explicit operator TxCircleD(CxGdiCircle src)
		{
			return src.Shape;
		}
		...
		///		新しく生成したオブジェクトを返します。
		/// </returns>
		public static explicit operator TxCircleI(CxGdiCircle src)
		{
			return (TxCircleI)src.Shape;
		}
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.Location")]
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.Bounds")]
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.Angle")]
		public double Angle
		{
			get { return m_Angle; }
			set { m_Angle = value; }
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.Axis")]
		...
		{
			if (prev_figure is CxGdiCircle)
			{
				var figure = (CxGdiCircle)prev_figure;
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.PenColor")]
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.PenWidth")]
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.PenStyle")]
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.BrushColor")]
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.BrushShadow")]
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.BrushStyle")]
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.HatchStyle")]
		...
		/// </summary>
		[CxCategory("Common")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.LinearGradientMode")]
		...
		[CxDescription("P:XIE.GDI.CxGdiCircle.X")]
		public double X
		{
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.Y")]
		public double Y
		{
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.GDI.CxGdiCircle.Radius")]
