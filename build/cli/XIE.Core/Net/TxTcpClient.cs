...
namespace XIE.Net
{
	...
	public struct TxTcpClient :
		IEquatable<TxTcpClient>
	{
		#region プロパティ:
		...
		/// </returns>
		public bool Equals(TxTcpClient other)
		{
		...
		public override bool Equals(object obj)
		{
			...
			if (!(obj is TxTcpClient)) return false;
			return this.Equals((TxTcpClient)obj);
		}
		...
		///		内容が等しい場合は true、それ以外は false を返します。
		/// </returns>
		public static bool operator ==(TxTcpClient left, TxTcpClient right)
		{
