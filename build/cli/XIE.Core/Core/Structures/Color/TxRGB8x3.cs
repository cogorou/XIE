...
namespace XIE
{
		...
		IEquatable<TxRGB8x3>
	{
		...
		[CxDescription("P:XIE.TxRGB8x3.R")]
		public byte R
		{
			get { return m_R; }
			set { m_R = value; }
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.TxRGB8x3.G")]
		public byte G
		{
			get { return m_G; }
			set { m_G = value; }
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.TxRGB8x3.B")]
		public byte B
		{
			get { return m_B; }
			set { m_B = value; }
		...
		public TxRGB8x3(byte red, byte green, byte blue)
		{
			m_R = red;
			m_G = green;
			m_B = blue;
		...
		/// </returns>
		public bool Equals(TxRGB8x3 other)
		{
		...
		public override bool Equals(object obj)
		{
			...
			if (!(obj is TxRGB8x3)) return false;
			return this.Equals((TxRGB8x3)obj);
		}
		...
		///		内容が等しい場合は true、それ以外は false を返します。
		/// </returns>
		public static bool operator ==(TxRGB8x3 left, TxRGB8x3 right)
		{
		...
		///		キャスト結果を返します。
		/// </returns>
		public static implicit operator TxBGR8x3(TxRGB8x3 src)
		{
		...
		///		キャスト結果を返します。
		/// </returns>
		public static implicit operator TxBGR8x4(TxRGB8x3 src)
		{
		...
		///		キャスト結果を返します。
		/// </returns>
		public static implicit operator TxRGB8x4(TxRGB8x3 src)
		{
		...
		///		キャスト結果を返します。
		/// </returns>
		public static implicit operator TxRGB8x3(Color src)
		{
		...
		///		キャスト結果を返します。
		/// </returns>
		public static implicit operator Color(TxRGB8x3 src)
		{
		...
		private class SelfConverter : CxSortingConverter
		{
			...
			{
				if (destinationType == typeof(TxRGB8x3)) return true;
				return base.CanConvertTo(context, destinationType);
			}

			public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType)
			{
				if (destinationType == typeof(string) && value is TxRGB8x3)
				{
					var _value = (TxRGB8x3)value;
					return string.Format("{0},{1},{2}",
						_value.R,
						_value.G,
						_value.B
		...
		/// <summary>
		/// カラー構造体 (RGB) 8bit プロパティグリッド用エディタ
		/// </summary>
		private class SelfEditor : System.Drawing.Design.ColorEditor
		{
			...
			{
				var color = (Color)(TxRGB8x3)value;
				var result = base.EditValue(context, provider, color);
				return (TxRGB8x3)(Color)result;
			}
			...
			{
				if (e.Value is TxRGB8x3)
				{
					var color = (Color)(TxRGB8x3)e.Value;
