...
namespace XIE
{
		...
		IEquatable<TxBGR8x4>
	{
		...
		[CxDescription("P:XIE.TxBGR8x4.R")]
		public byte R
		{
			get { return m_R; }
			set { m_R = value; }
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.TxBGR8x4.G")]
		public byte G
		{
			get { return m_G; }
			set { m_G = value; }
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.TxBGR8x4.B")]
		public byte B
		{
			get { return m_B; }
			set { m_B = value; }
		...
		/// </summary>
		[CxCategory("Parameters")]
		[CxDescription("P:XIE.TxBGR8x4.A")]
		public byte A
		{
			get { return m_A; }
			set { m_A = value; }
		...
		public TxBGR8x4(byte red, byte green, byte blue, byte alpha = 0xFF)
		{
			m_R = red;
			m_G = green;
			m_B = blue;
		...
		/// </returns>
		public bool Equals(TxBGR8x4 other)
		{
		...
		public override bool Equals(object obj)
		{
			...
			if (!(obj is TxBGR8x4)) return false;
			return this.Equals((TxBGR8x4)obj);
		}
		...
		///		内容が等しい場合は true、それ以外は false を返します。
		/// </returns>
		public static bool operator ==(TxBGR8x4 left, TxBGR8x4 right)
		{
		...
		///		キャスト結果を返します。
		/// </returns>
		public static implicit operator TxBGR8x3(TxBGR8x4 src)
		{
		...
		///		キャスト結果を返します。
		/// </returns>
		public static implicit operator TxRGB8x3(TxBGR8x4 src)
		{
		...
		///		キャスト結果を返します。
		/// </returns>
		public static implicit operator TxRGB8x4(TxBGR8x4 src)
		{
		...
		///		キャスト結果を返します。
		/// </returns>
		public static implicit operator TxBGR8x4(Color src)
		{
		...
		///		キャスト結果を返します。
		/// </returns>
		public static implicit operator Color(TxBGR8x4 src)
		{
		...
		private class SelfConverter : CxSortingConverter
		{
			...
			{
				if (destinationType == typeof(TxBGR8x4)) return true;
				return base.CanConvertTo(context, destinationType);
			}

			public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType)
			{
				if (destinationType == typeof(string) && value is TxBGR8x4)
				{
					var _value = (TxBGR8x4)value;
					return string.Format("{0},{1},{2},{3}",
						_value.R,
						_value.G,
						_value.B,
		...
		/// <summary>
		/// カラー構造体 (BGRA) 8bit プロパティグリッド用エディタ
		/// </summary>
		private class SelfEditor : System.Drawing.Design.ColorEditor
		{
			...
			{
				var color = (Color)(TxBGR8x4)value;
				var result = base.EditValue(context, provider, color);
				return (TxBGR8x4)(Color)result;
			}
			...
			{
				if (e.Value is TxBGR8x4)
				{
					var color = (Color)(TxBGR8x4)e.Value;
