namespace XIEstudio
{
	partial class CxImagePreviewForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CxImagePreviewForm));
			...
			this.panelView.Size = new System.Drawing.Size(304, 247);
			...
			this.Name = "CxImagePreviewForm";
			this.ShowInTaskbar = false;
			this.Text = "Preview";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.CxImagePreviewForm_FormClosing);
			this.Load += new System.EventHandler(this.CxImagePreviewForm_Load);
			this.Resize += new System.EventHandler(this.CxImagePreviewForm_Resize);
