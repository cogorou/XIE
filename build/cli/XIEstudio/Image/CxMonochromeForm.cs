...
namespace XIEstudio
{
	...
	/// モノクローム変換フォーム
	/// </summary>
	public partial class CxMonochromeForm : Form
	{
		#region コンストラクタ:
		...
		/// <param name="e"></param>
		private void CxMonochromeForm_Load(object sender, EventArgs e)
		{
			if (SrcImage == null)
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void CxMonochromeForm_FormClosing(object sender, FormClosingEventArgs e)
		{
		...
		[XIE.CxDescription("P:XIEstudio.CxMonochromeForm.SrcImage")]
		...
		/// </summary>
		[XIE.CxCategory("Parameters")]
		[XIE.CxDescription("P:XIEstudio.CxMonochromeForm.DstImage")]
		...
		/// パラメータ
		/// </summary>
		public static XIE.Effectors.CxMonochrome Param = new XIE.Effectors.CxMonochrome();
		...
		/// イフェクタ
		/// </summary>
		private XIE.Effectors.CxMonochrome Effector = new XIE.Effectors.CxMonochrome();
