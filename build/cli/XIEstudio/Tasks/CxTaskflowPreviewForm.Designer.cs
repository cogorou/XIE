namespace XIEstudio
{
	partial class CxTaskflowPreviewForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CxTaskflowPreviewForm));
			...
			this.Name = "CxTaskflowPreviewForm";
			this.ShowInTaskbar = false;
			this.Text = "Preview";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.CxTaskflowPreviewForm_FormClosing);
			this.Load += new System.EventHandler(this.CxTaskflowPreviewForm_Load);
			this.Resize += new System.EventHandler(this.CxTaskflowPreviewForm_Resize);
