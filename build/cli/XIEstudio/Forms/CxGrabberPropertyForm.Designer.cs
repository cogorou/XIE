namespace XIEstudio
{
	partial class CxGrabberPropertyForm
	{
		/// <summary>
		/// 必要なデザイナ変数です。
		/// </summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CxGrabberPropertyForm));
			...
			this.Name = "CxGrabberPropertyForm";
			this.Text = "Grabber Property";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.CxGrabberPropertyForm_FormClosing);
			this.Load += new System.EventHandler(this.CxGrabberPropertyForm_Load);
