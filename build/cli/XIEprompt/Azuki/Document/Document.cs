...
namespace Sgry.Azuki
{
	...
	/// </summary>
	class Document : IEnumerable<char>
	{
		#region Fields
		...
		///   specified with the <paramref name="startIndex"/> parameter
		///   and does not stop at line ends nor null-characters.
		///   If the search range should end before EOD,
		...
		///   <para>
		///   If an empty string was used for a regular expression pattern,
		///   search result will be a range of [<paramref name="startIndex"/>, <paramref name="startIndex"/>).
		///   </para>
		/// </remarks>
...
#			endif
	...
	/// </summary>
	delegate void ContentChangedEventHandler( object sender, ContentChangedEventArgs e );

	/// <summary>
	/// Event information about content change.
	/// </summary>
	class ContentChangedEventArgs : EventArgs
	{
		int _Index;
