...
#ifndef _CXVLCAMERA_H_INCLUDED_
#define _CXVLCAMERA_H_INCLUDED_
...
class XIE_EXPORT_CLASS CxVLCamera : public CxModule
	, public IxDisposable
...
public:
	...
	virtual void OpenPropertyDialog(Window window, ExMediaType type, int mode, TxCharCPtrA caption);
...
public:
	...
	virtual CxStringA GetDeviceName() const;
